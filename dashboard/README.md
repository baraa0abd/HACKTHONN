...
افتح العنوان `http://127.0.0.1:8899`. يشغّل الأمر اختبارات التحديين، ويحفظ نتائج التحقق الفعلية، ويعيد توليد دليل `PRESENTING.md` من الملفات الحالية، ثم يبدأ الخادم المحلي.
